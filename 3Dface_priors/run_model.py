...
def parse_args():
    ...
    # parser.add_argument('--data_dir', type=str, default=None, help='training datadir')
    parser.add_argument('--model', type=str, default='color', help='model type: [lstm | gray | color]')
    parser.add_argument('--face', type=str, default='coeff', help='3dface type: [coeff | render | both]')
    parser.add_argument('--batch_size', help='training batch size, must be 2^X', type=int, default=16)
    parser.add_argument('--patch_size', help='training batch size, must be 2^X', type=int, default=256)
    parser.add_argument('--levels', help='training scale number', type=int, default=1)
